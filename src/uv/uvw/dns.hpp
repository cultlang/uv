 ...
 */
class GetNameInfoReq final
	: public Request<GetNameInfoReq, uv_getnameinfo_t>
	, public virtual craft::types::Object
{
	CULTLANG_UV_EXPORTED CRAFT_OBJECT_DECLARE(uvw::GetNameInfoReq);
public:
